...
urlpatterns = [
     ...
     # Dokumen page
     path('panel/dokumen/', views_dokumen.dokumen_page, name='dokumen_list'),

     # Dokumen APIs
     path('api/dokumen/', views_dokumen.api_list_dokumen, name='api_list_dokumen'),

     path('api/dokumen/summary/', views_dokumen.api_dokumen_summary, name='api_dokumen_summary'),

     path('api/dokumen/upload/', views_dokumen.api_upload_dokumen, name='api_upload_dokumen'),
